...
const Button = ({ type }) => {
  return (
    <div className="flex items-center gap-1 border border-[#787486] rounded-md py-2 px-3">
      {type === 'Filter' && (
        <svg
          width="16"
          height="16"
      ...
      <p className="text-[#787486] font-medium text-base leading-[19px] font-['Inter'] not-italic">
        {type}
      </p>
      <svg
        xmlns="http://www.w3.org/2000/svg"
